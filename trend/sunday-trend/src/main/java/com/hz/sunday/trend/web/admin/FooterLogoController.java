...
public class FooterLogoController extends BaseController {
	
	/** 网站底部LOGO编辑页*/
	private static final String FOOTER_PAGE = "/trend/footer-input";
	...
	public void cancel(@RequestParam("id") Long id, HttpServletRequest request, HttpServletResponse response) {
		try {
			attachementBO.deleteAll(id.toString(), TrendConstants.MSG_TYPE + TrendConstants.FOOTER_LOGO);
