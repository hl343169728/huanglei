...
public class FirstLogoController extends BaseController {
	
	/** 首页LOGO编辑页*/
	private static final String FIRST_PAGE = "/trend/first-input";
	...
	public void cancel(@RequestParam("id") Long id, HttpServletRequest request, HttpServletResponse response) {
		try {
			attachementBO.deleteAll(id.toString(), TrendConstants.MSG_TYPE + TrendConstants.FIRST_LOGO);
