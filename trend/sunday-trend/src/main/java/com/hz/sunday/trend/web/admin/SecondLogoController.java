...
public class SecondLogoController extends BaseController {
	
	/** 次级页面LOGO编辑页*/
	private static final String SECOND_PAGE = "/trend/second-input";
	...
	public void cancel(@RequestParam("id") Long id, HttpServletRequest request, HttpServletResponse response) {
		try {
			attachementBO.deleteAll(id.toString(), TrendConstants.MSG_TYPE + TrendConstants.SECOND_LOGO);
