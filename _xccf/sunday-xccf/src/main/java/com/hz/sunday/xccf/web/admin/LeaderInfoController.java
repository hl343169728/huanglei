...
public class LeaderInfoController extends BaseController {
	...
	/** 顶尖领袖团编辑页*/
	private static final String LEADER_PAGE = "/xccf/leader/leaderDlg";
	...
	public void cancel(@RequestParam("id") Long id, HttpServletRequest request, HttpServletResponse response) {
		try {
			attachementBO.deleteAll(id.toString(), "messnoti" + ColumnType.LEADER_TYPE);
