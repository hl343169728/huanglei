...
public class AdvertInfoController extends BaseController {
	...
	/** 广告位页面*/
	private static final String ADVERT_PAGE = "/xccf/advert/advertDlg";
	...
	public void cancel(@RequestParam("id") Long id, HttpServletRequest request, HttpServletResponse response) {
		try {
			attachementBO.deleteAll(id.toString(), "messnoti" + ColumnType.ADVERT_IMAGE);
