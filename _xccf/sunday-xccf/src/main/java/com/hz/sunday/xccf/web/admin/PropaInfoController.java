 ...
 * 
 * @author huanglei
 * @date 2015年4月27日 下午10:49:10
 * @version V1.0
 */
@Controller
@RequestMapping("/admin/propaganda")
public class PropaInfoController extends BaseController {
	
	/** 销售宣传语编辑页*/
	private static final String PROPAGANDA_PAGE = "/xccf/propaganda/propagandaDlg";
