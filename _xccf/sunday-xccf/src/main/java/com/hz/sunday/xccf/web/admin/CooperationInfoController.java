...
public class CooperationInfoController extends BaseController {
	...
	/** 合作媒体页面*/
	private static final String COOPERATION_PAGE = "/xccf/cooperation/cooperationDlg";
	...
	public void cancel(@RequestParam("id") Long id, HttpServletRequest request, HttpServletResponse response) {
		try {
			attachementBO.deleteAll(id.toString(), "messnoti" + ColumnType.COOPERATION_TYPE);
