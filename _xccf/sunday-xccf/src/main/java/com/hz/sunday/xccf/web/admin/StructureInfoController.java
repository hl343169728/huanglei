 ...
 * 
 * @author huanglei
 * @date 2015年4月27日 下午8:07:34
 * @version V1.0
 */
@Controller
@RequestMapping("/admin/structure")
public class StructureInfoController extends BaseController {
	
	/** 组织结构编辑页*/
	private static final String STRUCTURE_PAGE = "/xccf/structure/structureDlg";
	...
	public void cancel(@RequestParam("id") Long id, HttpServletRequest request, HttpServletResponse response) {
		try {
			attachementBO.deleteAll(id.toString(), "messnoti" + ColumnType.STRUCTURE_TYPE);
