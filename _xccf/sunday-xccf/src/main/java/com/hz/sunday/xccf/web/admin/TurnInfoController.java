...
public class TurnInfoController extends BaseController {
	
	/** 轮番页面*/
	private static final String TURN_PAGE = "/xccf/turn/turnDlg";
	...
	public void cancel(@RequestParam("id") Long id, HttpServletRequest request, HttpServletResponse response) {
		try {
			attachementBO.deleteAll(id.toString(), "messnoti" + ColumnType.TURN_IMAGE);
