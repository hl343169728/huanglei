...
<html>
  <head>
    ...
    <title>My JSP 'class_detail.jsp' starting page</title>
  ...
  <body>
    	<form action="" method="post">
    		<table border="1" style="border-collapse: collapse;">
    			<tr><td>班级名称：</td><td>${clz.cname}</td></tr>
	    		<tr><td>地址：</td><td>${clz.address}</td></tr>
	    		<tr><td>任课教师：</td><td>${clz.teacher}</td></tr>
	    		<tr><td>行数：</td><td>${clz.crow}</td></tr>
	    		<tr><td>列数：</td><td>${clz.ccol}</td></tr>
    		</table>
    	</form>
    	<hr/>
   				...
   				<tr>
   					<s:iterator var="j" begin="1" end="clz.ccol">
   						<td>
   							...
   							<s:else>
   								<div onclick="addStudent(${clz.id},${i},${j});" style="background-color: yellow; width: 100px; height: 100px;">
   									此位置暂时无人
   								</div>
   							</s:else>		
   						</td>
