...
<html>
  <head>
    ...
    <title>My JSP 'more_upload.jsp' starting page</title>
	...
	<script type="text/javascript">
		...
		function add(){
			...
			myCreate(mydiv,{nodeName:'input',type:'file',name:'image'});
  ...
  <body>
    	<form action="DemoAction!upload" method="post">
    		上传者：<input name="uname" value=""/><br/>
    		图片：<input type="button" value="添加图片 " onclick="add();"/><br/> 
    		<div id="mydiv"></div>
