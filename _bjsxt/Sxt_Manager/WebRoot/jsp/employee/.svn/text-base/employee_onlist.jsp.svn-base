	...
	<script type="text/javascript">
			$(function(){
				...
				$('#t_emp').datagrid({
						...
						url: 'EmployeeAction!getEmployeeList?flag=1',	//发送Ajax异步请求 从服务器端数据 
						remoteSort: false ,
						...
						columns:[[
							...
							{field:'ruzhiTime',	title:'入职日期' ,	width:80, align:'center'  },
							...
							{field:'operation',	title:'操作' ,		width:100, align:'center'  , 
								formatter : function(value , record , index){
									return "<a href=EmployeeAction!preUpdateEmployee?id="+record.id+" >修改</a> | <a href='javascript:void(0);' onclick='isleave("+record.id+")' >申请离职</a>" ; 	  									
								}
							}
						]] 
				});
