...
<html>
  <head>
    ...
    <title>My JSP 'memo_allList.jsp' starting page</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#t_all').datagrid({
					...
					url: 'MemoAction!getMemoList?flag=2', 			//发送Ajax异步请求 从服务器端取数据 （从远程请求数据的地址）  
					...
					columns:[[
						...
						{field:'operation',		title:'操作' ,			width:100, align:'center'  , 
							formatter : function(value , record , index){
								return "<a href='javascript:void(0);' onclick=preUpdate("+record.id+",2); >修改</a> | <a href='javascript:void(0);' onclick=deleteMemo("+record.id+",2)>删除</a> " ;	    									
							}
						}
					]]
			});
