...
<html>
  <head>
    ...
    <title>My JSP 'position_update.jsp' starting page</title>
  ...
  <body>
	<form action="PositionServlet" method="post">
		...
		<table>
			...
			<tr>
				...
				<td>
					<select name="level">
						...
						<option value="1" ${position.level eq "1"?"selected":"" }>高级</option>
						<option value="2" ${position.level eq "2"?"selected":"" }>中级</option>
						<option value="3" ${position.level eq "3"?"selected":"" }>普通</option>
					</select>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><input type="submit" value="修改岗位" /></td>
